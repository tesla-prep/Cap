...
**Are analytics available by default?**

Basic analytics including view counts are available. Detailed analytics with unique views may depend on your workspace configuration.
