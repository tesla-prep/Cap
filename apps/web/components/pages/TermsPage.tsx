				...
				<div className="text-left legal-body fade-in-up animate-delay-2">
					<ol>
						...
						<li>
							...
							which is incorporated into these Terms, to understand our
						...
						<li>
							...
							arising from your use of and access to our Services or your
						...
						<li>
							...
							federal or state courts located in Dover, Delaware, and you
						...
						<li>
							...
							effect. By continuing to access or use our Services after any
